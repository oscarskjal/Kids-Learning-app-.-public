<template>
    <div class="game-container">
      <h2 class="game-title">Välj rätt alternativ för det tomma fältet</h2>

      
      <div v-if="currentSentenceIndex < sentences.length" class="sentence">
      ...
      <div class="score">Poäng: {{ score }} / {{ sentences.length }}</div>
      <SpaceShip :score="score" :total="sentences.length" />
